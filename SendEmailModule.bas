...
Sub Send_Email(wkNr As String, customer As String, reasonForTrip As String, systemType As String, saveDirectory As String, reportName As String, serialNumber As String, name As String)
